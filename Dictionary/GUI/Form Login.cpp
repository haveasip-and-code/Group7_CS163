...
: wxFrame((wxFrame *) NULL, wxID_ANY, title, wxPoint(wxID_ANY, wxID_ANY), wxSize(1200, 750),
wxSYSTEM_MENU | wxMINIMIZE_BOX | wxCLOSE_BOX | wxMAXIMIZE_BOX | wxCAPTION | wxCLIP_CHILDREN)
{
    ...
    m_image = wxImage("login.png", wxBITMAP_TYPE_ANY);
    if ( !m_image.IsOk() )
    {
        return;
    }
    ...
    hbox1->Add(m_usernameEntry, 0, wxALIGN_CENTRE | wxBOTTOM, 5);
    ...
    hbox2->Add(m_passwordEntry, 0, wxALIGN_CENTER|wxBOTTOM, 5);
    ...
    vbox->Add(vbox_above_middle, 1, wxEXPAND | wxRIGHT, 120);
